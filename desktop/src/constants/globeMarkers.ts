...
export const markers: Marker[] = [
  {
    ...
    date: 'Fall of 2023',
    description:
      'We were lucky to taste the flavors of Tuscany during our stay in Florence. The Chianti Classico wine was so delicious that we had to order some to take home.',
    imageSrc: `${globeImagesPath}/47braml7Dv.webp`,
    lat: 43.7538,
    lng: 11.2194,
  },
  {
    ...
    date: 'Fall of 2023',
    description:
      'Stepping into the Roman Colosseum is like journeying back in time, where the ancient echoes of gladiator battles and the sheer grandeur of the amphitheater transport visitors to a captivating era of Roman history.',
    imageSrc: `${globeImagesPath}/hs34xDD6g2.webp`,
    lat: 41.5871,
    lng: 13.3192,
  },
  {
    title: 'Sky Ponies',
    location: 'Pyrenees, Italy',
    date: 'Fall of 2023',
    description:
      'Embarking on a hiking adventure with horses adds an enchanting dimension to the journey. We were lucky to have met a group of friendly horses who happily let us pet them. They seemed to enjoy our company!',
    imageSrc: `${globeImagesPath}/F5Ja8bT2x5.webp`,
    lat: 42.6682,
    lng: 1.4461,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/js02SD12mx.webp`,
    lat: 39.7392,
    lng: -104.9903,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/Kq1LBMzOgr.webp`,
    lat: 39.6433,
    lng: -108.3781,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/wg0Fp4y2cC.webp`,
    lat: 48.9167,
    lng: -118.5,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/Bgn5KIb3MN.webp`,
    lat: 49.9167,
    lng: -122.75,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/JmhhCcMRNf.webp`,
    lat: 43.7904,
    lng: -110.6818,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/4A2L1ScIVK.webp`,
    lat: 39.2,
    lng: -119.5,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/QL6A5bFs4i.webp`,
    lat: 37.7749,
    lng: -122.4194,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/sppdwlx2IM.webp`,
    lat: 41.4993,
    lng: -81.6944,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/ydO77WYakD.webp`,
    lat: 38.627,
    lng: -90.1994,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/k27Lt7w4SG.webp`,
    lat: -31.9249,
    lng: 17.4241,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/ybX2pddzKz.webp`,
    lat: -33.6158,
    lng: 20.0,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/AVsP3eH8o0.webp`,
    lat: 18.5601,
    lng: -68.3725,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/15o5GisKOx.webp`,
    lat: 17.0747,
    lng: -61.8175,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/VkoL1Z5t7u.webp`,
    lat: 21.1619,
    lng: -86.8515,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/dNdheU3zCg.webp`,
    lat: 45.6047,
    lng: 1.4442,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/C1IPRDRcrJ.webp`,
    lat: 34.0478,
    lng: -87.0249,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/OXzleniTJY.webp`,
    lat: 30.4548,
    lng: -97.6223,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/B9uaTAoQQb.webp`,
    lat: 43.8803,
    lng: -103.4538,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/0Ou6rGjcJZ.webp`,
    lat: 42.5847,
    lng: -87.8212,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/yZCBDwALXZ.webp`,
    lat: 35.0844,
    lng: -106.6504,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/lpZCBDmwhB.webp`,
    lat: -6.1622,
    lng: 39.1921,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/13yKiPPxd1.webp`,
    lat: -18.4256,
    lng: 24.7143,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/hj5n3NEtLU.webp`,
    lat: -23.9884,
    lng: 31.5547,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/qCoVy84S2p.webp`,
    lat: -17.9257,
    lng: 27.8625,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/F1aH8cIeF8.webp`,
    lat: 40.7128,
    lng: -74.006,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/uVPj8d5P73.webp`,
    lat: 36.0544,
    lng: -112.1401,
  },
  {
    ...
    imageSrc: `${globeImagesPath}/ePch0iKO3Z.webp`,
    lat: 45.4884,
    lng: -77.6784,
  },
];
