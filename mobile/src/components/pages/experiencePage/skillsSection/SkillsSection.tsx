...
const SkillsSection = () => {
  ...
  const renderSkills = (skillsData: Skill[]) =>
  ...
  const renderDevPractices = (devPracticesData: Skill[]) =>
    devPracticesData.map((skill) => (
      <DevPractice
        key={skill.displayText}
        techName={skill.displayText}
        imagePath={skill.imagePath}
  ...
  return (
    <>
      <div className={bem()}>
        ...
        <div className={bem('section-title')}>Dev Practices</div>
        <div className={bem('section')}>{renderDevPractices(devPractices)}</div>
